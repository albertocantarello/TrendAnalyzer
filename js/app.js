...
function renderTrends(trends, container) {
    ...
    trends.forEach((trend, index) => {
        // Assegna colori specifici in base alla "Frequenza" per un impatto visivo immediato
        let freqColor = "bg-slate-700/50 text-slate-300 border-slate-600"; // default
        let icon = "fa-fire";
        ...
        // Effetto a cascata (stagger) nell'animazione
